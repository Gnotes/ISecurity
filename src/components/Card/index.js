...
class Card extends PureComponent {
  render() {
    const { shadow, type, onClickAdd, onClickIcon, className } = this.props;
    return (
      <div className={classNames('card', {
        ...
        <div className="card-left">
          {
            type === 'password' ? (
              <Avatar className="card-logo" onClick={onClickIcon}>G</Avatar>
          ...
          type === 'password' ? (
            <div className="card-right">
              <div className="card-action">
                <Link className="card-icon icon-link" />
              ...
              <div className="card-content">
                <div className="card-title">1245036094@qq.com</div>
